...
export default function Nav() {
  return (
    <Head>
      ...
      {process.env.NODE_ENV === 'development' ? null : <script src='/script/disable_devtool.js' />}
      ...
      />
      <meta name='keywords' content='developer, lap trinh vien , harrison, hoang' />
      <meta name='theme-color' content='#171060' />
      ...
      <meta name='msapplication-TileColor' content='#171060' />
      <meta name='msapplication-TileImage' content='/icon/maskable_icon_x512.png' />
      <meta name='theme-color' content='#171060' />
